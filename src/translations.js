export const content = {
  ...
  es: {
    ...
    certifications: "Certificado y Reconocido Por:",
    about: {
      title: "Sobre PPM",
      desc: "PPM es un exportador registrado de sustratos orgánicos sostenibles de la India. Suministramos bloques de fibra de coco de alta calidad a viveros y cultivos hidropónicos.",
  ...
  nl: {
    ...
    certifications: "Gecertificeerd en Erkend Door:",
    about: {
      title: "Over PPM",
      desc: "PPM is een geregistreerde exporteur van duurzame substraten uit India. Wij leveren hoogwaardige kokosgruis (cocopeat) aan kwekerijen wereldwijd.",
  ...
  fr: {
    ...
    certifications: "Certifié et Reconnu Par:",
    about: {
      title: "À propos de PPM",
      desc: "PPM est un exportateur indien de tourbe de coco (moelle de coco) de haute qualité pour les pépinières et fermes hydroponiques du monde entier.",
  ...
  cn: {
    ...
    certifications: "认证与认可:",
    about: {
      title: "关于 PPM",
      desc: "PPM 是印度政府注册的出口商，为世界各地的苗圃和水培农场提供高质量的椰糠和椰壳纤维块。",
  ...
  ko: {
    ...
    certifications: "인증 및 인정:",
    about: {
      title: "PPM 소개",
      desc: "PPM은 인도의 지속 가능한 유기농 배양토 수출업체입니다. 전 세계 묘목장 및 수경 재배 농장에 고품질 코코피트 블록을 제공합니다.",
      tagline: "100% 유기농 • 친환경 • 지속 가능"
    },
    products: {
      title: "제품 소개",
      items: [
        {
          name: "세척 코코피트 (Washed Coco Peat)",
          desc: "표준 세척 코코피트 블록. 높은 수분 유지력, 낮은 EC, 일반 원예 및 노지 농업을 위한 탁월한 통기성.",
          use: "용도: 화분 흙, 조경, 토양 개량",
          hsn: "53050040",
          img: "/assets/coco-block.jpeg"
        },
        {
          name: "버퍼링 코코 블록 (Buffered)",
          desc: "나트륨과 칼륨을 제거하기 위해 질산칼슘으로 화학 처리됨. 매우 낮은 EC, pH 균형 및 안정적인 구조.",
          use: "용도: 수경 재배, 전문 재배 가방, 민감한 작물",
          hsn: "53050040",
          img: "/assets/coco-brick.jpeg"
        }
      ]
    ...
    form: {
      title: "문의하기",
      subtitle: "아래 양식을 작성해 주시면 CIF/FOB 견적을 보내드립니다.",
      fields: {
        name: "성함",
        phone: "전화번호",
        address: "주소",
